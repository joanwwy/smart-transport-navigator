        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="flex gap-6 h-16 items-center">
            <button
              onClick={() => onTabChange('plan')}
              id="tab-plan"
              className={`h-full flex items-center px-2 text-[13px] font-semibold transition-all border-b-2 ${
                activeTab === 'plan'
            ...
            <button
              ...
              id="tab-alerts"
              className={`h-full flex items-center gap-1.5 px-2 text-[13px] font-semibold transition-all border-b-2 ${
                activeTab === 'alerts'
                  ? 'text-primary border-primary'
                  : 'text-on-surface-variant hover:text-on-surface border-transparent hover:border-outline-variant'
              }`}
